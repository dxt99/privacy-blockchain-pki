...
class VerifyService:
    ...
    def verify(self, transactions: dict, verifying_key: rsa.RSAPublicKey = None) -> bool:
        ...
        for id, transaction in sorted_tx[1:]:
            res &= self.__verify_single(id, transaction, previous_key, verifying_key)
    ...
    def __verify_single(self, id: int, transaction: Transaction, data: str, verifying_key: rsa.RSAPublicKey = None) -> bool:
        ...
        try:
            ...
            decrypted_signature = verifying_key.decrypt(
                data_signature,
